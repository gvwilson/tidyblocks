...
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_colors.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
...
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_earthquakes.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
...
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_iris.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
...
<h1><a id="#data_cars">Cars Dataset</a></h1>
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_cars.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
...
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_toothgrowth.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
...
<div id="wrapper">
    <div id="first"> 
    <img src="/guide/images/data_importCSV.png" width="100%"> 
    </div>
    <div id="second">
    <h3>Description:</h3>
