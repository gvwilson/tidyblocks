...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"utilities/tb_util.js":[function(require,module,exports) {
...
function initializeDisplay() {
  for (var _i = 0, _arr = [['codeOutput', 'none'], ['blockDisplay', 'block']]; _i < _arr.length; _i++) {
...
function blockToText() {
  for (var _i2 = 0, _arr2 = ['codeOutput', 'blockDisplay']; _i2 < _arr2.length; _i2++) {
    var nodeId = _arr2[_i2];
...
function runCode() {
  ...
  if (code.includes("vega")) {
    ...
    var _dfArray = eval(splitdf[0]).toArray();

    console.log(_dfArray);
    eval(splitdf[1]);
  } else {
    console.log(code);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","utilities/tb_util.js"], null)
//# sourceMappingURL=/tb_util.1831a8a7.js.map