...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"blockly/blocks_compressed.js":[function(require,module,exports) {
...
Blockly.Blocks.procedures_defnoreturn = {
  ...
  displayRenamedVar_: function displayRenamedVar_(a, b) {
    this.updateParams_();
    if (this.mutator.isVisible()) for (var c = this.mutator.workspace_.getAllBlocks(!1), d = 0, e; e = c[d]; d++) {
  ...
  customContextMenu: function customContextMenu(a) {
    if (!this.isInFlyout) {
      ...
      for (var e = 0; e < this.arguments_.length; e++) {
        c = document.createElement("arg"), c.setAttribute("name", this.arguments_[e]), d.appendChild(c);
      }
      ...
      a.push(b);
      if (!this.isCollapsed()) for (e = 0; e < this.argumentVarModels_.length; e++) {
        b = {
          enabled: !0
    ...
    if (this.workspace && !this.workspace.isFlyout && (a.type == Blockly.Events.BLOCK_DELETE || a.type == Blockly.Events.BLOCK_CREATE)) {
      ...
      if (a.type == Blockly.Events.BLOCK_DELETE) {
        ...
        for (b = 0; b < c.length; b += 1) {
          -1 == a.indexOf(c[b].name) && this.workspace.deleteVariableById(c[b].getId());
        }
      } else if (a.type == Blockly.Events.BLOCK_CREATE && (c = this.workspace.getBlockById(a.blockId), c.getField("NAME") && (d = c.getFieldValue("NAME"), (a = this.workspace.getVariable(d)) || (a = this.workspace.createVariable(d)), !c.previousConnection.isConnected() && !c.nextConnection.isConnected()))) for (d = 0; d < b.length; d += 1) {
  ...
  setProcedureParameters_: function setProcedureParameters_(a, b) {
    ...
    if (b) if (a.join("\n") == this.arguments_.join("\n")) this.quarkIds_ = b;else {
      ...
      for (e = 0; e < this.arguments_.length; e++) {
        d = Blockly.Variables.getOrCreateVariablePackage(this.workspace, null, this.arguments_[e], ""), this.argumentVarModels_.push(d);
      }

      this.updateShape_();
      if (this.quarkIds_ = b) for (e = 0; e < this.arguments_.length; e++) {
        d = this.quarkIds_[e], d in this.quarkConnections_ && (f = this.quarkConnections_[d], Blockly.Mutator.reconnect(f, this, "ARG" + e) || delete this.quarkConnections_[d]);
      }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","blockly/blocks_compressed.js"], null)
//# sourceMappingURL=/blocks_compressed.b5f4254b.js.map