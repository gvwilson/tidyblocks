...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"blockly/blockly_compressed.js":[function(require,module,exports) {
...
goog.debug.entryPointRegistry.register = function (a) {
  ...
  if (goog.debug.entryPointRegistry.monitorsMayExist_) for (var b = goog.debug.entryPointRegistry.monitors_, c = 0; c < b.length; c++) {
...
goog.Disposable.prototype.disposeInternal = function () {
  if (this.onDisposeCallbacks_) for (; this.onDisposeCallbacks_.length;) {
...
goog.events.removeAll = function (a, b) {
  ...
  for (f in c.listeners) {
    if (!e || f == e) for (var g = c.listeners[f].concat(), h = 0; h < g.length; ++h) {
...
goog.dom.setProperties = function (a, b) {
  goog.object.forEach(b, function (b, d) {
    b && "object" == _typeof(b) && b.implementsGoogStringTypedString && (b = b.getTypedStringValue());
...
goog.dom.getTextContent_ = function (a, b, c) {
  if (!(a.nodeName in goog.dom.TAGS_TO_IGNORE_)) if (a.nodeType == goog.dom.NodeType.TEXT) c ? b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : b.push(a.nodeValue);else if (a.nodeName in goog.dom.PREDEFINED_TAG_VALUES_) b.push(goog.dom.PREDEFINED_TAG_VALUES_[a.nodeName]);else for (a = a.firstChild; a;) {
...
goog.dom.getNodeAtOffset = function (a, b, c) {
  ...
  for (var d = 0, e = null; 0 < a.length && d < b;) {
    if (e = a.pop(), !(e.nodeName in goog.dom.TAGS_TO_IGNORE_)) if (e.nodeType == goog.dom.NodeType.TEXT) {
      var f = e.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(/ +/g, " ");
      d += f.length;
    } else if (e.nodeName in goog.dom.PREDEFINED_TAG_VALUES_) d += goog.dom.PREDEFINED_TAG_VALUES_[e.nodeName].length;else for (f = e.childNodes.length - 1; 0 <= f; f--) {
...
goog.style.setStyle = function (a, b, c) {
  if (goog.isString(b)) goog.style.setStyle_(a, c, b);else for (var d in b) {
...
goog.style.setUnselectable = function (a, b, c) {
  ...
  } else if (goog.userAgent.IE || goog.userAgent.OPERA) if (b = b ? "on" : "", a.setAttribute("unselectable", b), c) for (a = 0; e = c[a]; a++) {
...
goog.events.EventHandler.prototype.listenOnce_ = function (a, b, c, d, e) {
  if (goog.isArray(b)) for (var f = 0; f < b.length; f++) {
...
goog.events.EventTarget.dispatchEventInternal_ = function (a, b, c) {
  ...
  if (c) for (f = 0; !b.propagationStopped_ && f < c.length; f++) {
...
goog.debug.Logger.prototype.doLogRecord_ = function (a) {
  ...
  if (goog.debug.Logger.ENABLE_HIERARCHY) for (var b = this; b;) {
...
goog.debug.Logger.prototype.callPublish_ = function (a) {
  if (this.handlers_) for (var b = 0, c; c = this.handlers_[b]; b++) {
    c(a);
  }
};
...
goog.async.nextTick.getSetImmediateEmulator_ = function () {
  ...
  "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !goog.labs.userAgent.engine.isPresto() && (a = function a() {
...
goog.Promise.allSettled = function (a) {
  return new goog.Promise(function (b, c) {
    var d = a.length,
        e = [];
    if (d) for (var f = function f(a, c, _f) {
      d--;
      e[a] = c ? {
        fulfilled: !0,
        value: _f
...
goog.Promise.prototype.removeUnhandledRejection_ = function () {
  if (0 < goog.Promise.UNHANDLED_REJECTION_DELAY) for (var a = this; a && a.unhandledRejectionId_; a = a.parent_) {
    goog.global.clearTimeout(a.unhandledRejectionId_), a.unhandledRejectionId_ = 0;
  } else if (0 == goog.Promise.UNHANDLED_REJECTION_DELAY) for (a = this; a && a.hadUnhandledRejection_; a = a.parent_) {
...
goog.structs.forEach = function (a, b, c) {
  if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);else if (goog.isArrayLike(a) || goog.isString(a)) goog.array.forEach(a, b, c);else for (var d = goog.structs.getKeys(a), e = goog.structs.getValues(a), f = e.length, g = 0; g < f; g++) {
...
goog.structs.Trie.prototype.remove = function (a) {
  ...
  for (delete b.value_; 0 < c.length;) {
    if (e = c.pop(), b = e[0], e = e[1], b.childNodes_[e].isEmpty()) delete b.childNodes_[e];else break;
  }
...
Blockly.utils.runAfterPageLoad = function (a) {
  if ("object" != (typeof document === "undefined" ? "undefined" : _typeof(document))) throw Error("Blockly.utils.runAfterPageLoad() requires browser document.");
...
Blockly.Xml.blockToDom = function (a, b) {
  ...
  e && (d = Blockly.Xml.utils.createElement("comment"), d.appendChild(Blockly.Xml.utils.createTextNode(e)), "object" == _typeof(a.comment) && (d.setAttribute("pinned", a.comment.isVisible()), e = a.comment.getBubbleSize(), d.setAttribute("h", e.height), d.setAttribute("w", e.width)), c.appendChild(d));
...
Blockly.Xml.cloneShadow_ = function (a) {
  for (var b = a = a.cloneNode(!0), c; b;) {
    if (b.firstChild) b = b.firstChild;else {
      for (; b && !b.nextSibling;) {
        c = b, b = b.parentNode, 3 == c.nodeType && "" == c.data.trim() && b.firstChild != c && Blockly.utils.removeNode(c);
      }
  ...
  for (var g; g = a.childNodes[e]; e++) {
    if (3 != g.nodeType) {
      for (var h = f = null, k = 0, l; l = g.childNodes[k]; k++) {
        1 == l.nodeType && ("block" == l.nodeName.toLowerCase() ? f = l : "shadow" == l.nodeName.toLowerCase() && (h = l));
      }
...
Blockly.ConnectionDB.prototype.getNeighbours = function (a, b) {
  ...
  for (var d = this.connections_, e = a.x_, f = a.y_, g = 0, h = d.length - 2, k = h; g < k;) {
...
Blockly.Tooltip.onMouseOver_ = function (a) {
  if (!Blockly.Tooltip.blocked_) {
    for (a = a.target; "string" != typeof a.tooltip && "function" != typeof a.tooltip;) {
      a = a.tooltip;
    }
...
Blockly.Grid.createDom = function (a, b, c) {
  ...
  0 < b.length && 0 < b.spacing ? (Blockly.utils.createSvgElement("line", {
    ...
    stroke: b.colour
  }, a)) : Blockly.utils.createSvgElement("line", {}, a);
  return a;
};
...
Blockly.Trashcan.prototype.click = function () {
  if (this.hasBlocks_) {
    for (var a = [], b = 0, c; c = this.contents_[b]; b++) {
      a[b] = Blockly.Xml.textToDom(c).firstChild;
    }
...
Blockly.Variables.flyoutCategoryBlocks = function (a) {
  ...
  if (0 < a.length) {
    ...
    Blockly.Blocks.math_change && (d = Blockly.Blocks.variables_get ? 20 : 8, d = Blockly.Xml.textToDom('<xml><block type="math_change" gap="' + d + '">' + c + '<value name="DELTA"><shadow type="math_number"><field name="NUM">1</field></shadow></value></block></xml>').firstChild, b.push(d));
    if (Blockly.Blocks.variables_get) for (a.sort(Blockly.VariableModel.compareByName), c = 0; d = a[c]; c++) {
      d = '<xml><block type="variables_get" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(d) + "</block></xml>", d = Blockly.Xml.textToDom(d).firstChild, b.push(d);
    }
  }
...
Blockly.VariablesDynamic.flyoutCategoryBlocks = function (a) {
  ...
  if (0 < a.length) {
    ...
    if (Blockly.Blocks.variables_get_dynamic) {
      ...
      for (var d = 0; c = a[d]; d++) {
        c = '<xml><block type="variables_get_dynamic" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(c) + "</block></xml>", c = Blockly.Xml.textToDom(c).firstChild, b.push(c);
      }
    }
  }
    ...
    if (this.options.collapse) {
      ...
      var m = function m(a) {
        for (var b = 0, c = 0; c < e.length; c++) {
          for (var d = e[c]; d;) {
            setTimeout(d.setCollapsed.bind(d, a), b), d = d.getNextBlock(), b += 10;
          }
        }
      };
...
Blockly.Extensions.registerMixin = function (a, b) {
  if (!b || "object" != _typeof(b)) throw Error('Error: Mixin "' + a + '" must be a object');
...
Blockly.Extensions.buildTooltipForDropdown = function (a, b) {
  var c = [];
  "object" == (typeof document === "undefined" ? "undefined" : _typeof(document)) && Blockly.utils.runAfterPageLoad(function () {
    for (var a in b) {
...
Blockly.Field.prototype.init = function () {
  ...
  }, this.fieldGroup_), this.updateEditable(), this.clickTarget_ = this.getSvgRoot(), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.clickTarget_, "mousedown", this, this.onMouseDown_));
};
...
Blockly.Warning.prototype.setVisible = function (a) {
  if (a != this.isVisible()) if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "warningOpen", !a, a)), a) {
    ...
    this.bubble_.setSvgId(this.block_.id);
    if (this.block_.RTL) for (var b = a.getBBox().width, c = 0, d; d = a.childNodes[c]; c++) {
...
Blockly.Block = function (a, b, c) {
  ...
  if (b) {
    this.type = b;
    c = Blockly.Blocks[b];
    if (!c || "object" != _typeof(c)) throw TypeError("Unknown block type: " + b);
    goog.mixin(this, c);
  }
...
Blockly.Block.prototype.setConnectionsHidden = function (a) {
  ...
  } else for (var c = this.getConnections_(!0), d = 0; b = c[d]; d++) {
...
Blockly.Block.prototype.jsonInit = function (a) {
  ...
  for (var c = 0; void 0 !== a["message" + c];) {
    this.interpolate_(a["message" + c], a["args" + c] || [], a["lastDummyAlign" + c]), c++;
  }
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
  ...
  a.length && ("string" == typeof a[a.length - 1] || Blockly.utils.startsWith(a[a.length - 1].type, "field_")) && (g = {
    type: "input_dummy"
  ...
  for (g = 0; g < a.length; g++) {
    if (e = a[g], "string" == typeof e) b.push([e, void 0]);else {
      d = f = null;

      do {
        if (h = !1, "string" == typeof e) f = new Blockly.FieldLabel(e);else switch (e.type) {
          case "input_value":
...
Blockly.BlockSvg.prototype.setCollapsed = function (a) {
  if (this.collapsed_ != a) {
    ...
    b.length || (b[0] = this);
    if (this.rendered) for (c = 0; e = b[c]; c++) {
      e.render();
    }
  }
};
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
  if (!this.workspace.options.readOnly && this.contextMenu) {
    ...
    if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
      ...
      if (!this.collapsed_) for (var d = 1; d < this.inputList.length; d++) {
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
  ...
  for (a = 0; p = c[a]; a++) {
    if (p.thicker = !1, p.type == Blockly.BlockSvg.INLINE) for (b = 0; m = p[b]; b++) {
...
Blockly.DropDownDiv.getPositionMetrics = function (a, b, c, d) {
  ...
  e = Blockly.utils.clampNumber(Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING, k - a, f.width - Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING - Blockly.DropDownDiv.ARROW_SIZE);
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
  ...
  b = Math.atan(-a / c);
  isNaN(b) || (b = Blockly.utils.toDegrees(b), 0 > c ? b += 180 : 0 < a && (b += 360), b = Blockly.FieldAngle.CLOCKWISE ? Blockly.FieldAngle.OFFSET + 360 - b : b - Blockly.FieldAngle.OFFSET, Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), b = this.callValidator(b), Blockly.FieldTextInput.htmlInput_.value = b, this.setValue(b), this.validate_(), this.resizeEditor_());
};
...
Blockly.FieldDropdown.prototype.setValue = function (a) {
  if (!(null === a || a === this.value_ && this.text_)) {
    ...
    for (var b = this.getOptions(), c = 0; c < b.length; c++) {
      if (b[c][1] == a) {
        a = b[c][0];
        "object" == _typeof(a) ? (this.imageJson_ = a, this.text_ = a.alt) : (this.imageJson_ = null, this.text_ = a);
        this.forceRerender();
        return;
      }
    }
...
Blockly.FieldDropdown.prototype.render_ = function () {
  if (this.visible_) {
    ...
    for (var a; a = this.textElement_.firstChild;) {
      this.textElement_.removeChild(a);
    }
...
Blockly.FieldImage.prototype.init = function () {
  ...
  }, this.fieldGroup_), this.setValue(this.src_), this.setText(this.text_), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.tooltip_ ? this.imageElement_.tooltip = this.tooltip_ : this.setTooltip(this.sourceBlock_), Blockly.Tooltip.bindMouseEvents(this.imageElement_), this.maybeAddClickHandler_());
};
...
Blockly.Generator.prototype.blockToCode = function (a, b) {
  ...
  if ("string" == typeof c) {
    ...
    this.STATEMENT_PREFIX && (c = this.STATEMENT_PREFIX.replace(/%1/g, "'" + d + "'") + c);
  ...
  for (var b = [], c = [], d = this.permanentlyDisabled_.length = 0, e; e = a[d]; d++) {
    if (e.tagName) {
      ...
      if ("BLOCK" == f) f = Blockly.Xml.domToBlock(e, this.workspace_), f.disabled && this.permanentlyDisabled_.push(f), b.push({
        type: "block",
        block: f
      }), e = parseInt(e.getAttribute("gap"), 10), c.push(isNaN(e) ? g : e);else if ("SEP" == e.tagName.toUpperCase()) e = parseInt(e.getAttribute("gap"), 10), !isNaN(e) && 0 < c.length ? c[c.length - 1] = e : c.push(g);else if ("BUTTON" == f || "LABEL" == f) e = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_, e, "LABEL" == f), b.push({
        type: "button",
        button: e
      }), c.push(g);
    }
...
Blockly.Flyout.prototype.clearOldBlocks_ = function () {
  ...
  for (b = 0; b < this.mats_.length; b++) {
    (a = this.mats_[b]) && Blockly.utils.removeNode(a);
  }
...
Blockly.Flyout.prototype.filterForCapacity_ = function () {
  for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++) {
    if (-1 == this.permanentlyDisabled_.indexOf(c)) for (var d = !this.targetWorkspace_.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(c)); c;) {
      c.setDisabled(d), c = c.getNextBlock();
    }
  }
};
...
Blockly.VerticalFlyout.prototype.reflowInternal_ = function () {
  ...
  if (this.width_ != a) {
    for (c = 0; d = b[c]; c++) {
      this.RTL && (e = d.getRelativeToSurfaceXY().x, d.moveBy(a / this.workspace_.scale - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH - e, 0)), d.flyoutRect_ && this.moveRectToBlock_(d.flyoutRect_, d);
    }

    if (this.RTL) for (c = 0; d = this.buttons_[c]; c++) {
      b = d.getPosition().y, d.moveTo(a / this.workspace_.scale - d.width - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH, b);
    }
    this.width_ = a;
    this.position();
  }
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
  ...
  b.readOnly || e.isMovable() || e.addChangeListener(function (a) {
    if (!e.isDragging() && !e.isMovable() && -1 != Blockly.Events.BUMP_EVENTS.indexOf(a.type)) {
      ...
      e.isContentBounded() ? (c = e.getBlocksBoundingBox(), b.contentLeft = c.x, b.contentTop = c.y, b.contentRight = c.x + c.width, b.contentBottom = c.y + c.height) : (b.contentLeft = c.contentLeft / d, b.contentTop = c.contentTop / d, b.contentRight = (c.contentLeft + c.contentWidth) / d, b.contentBottom = (c.contentTop + c.contentHeight) / d);
...
Blockly.inject.bindDocumentEvents_ = function () {
  ...
  }), Blockly.bindEventWithChecks_(document, "keydown", null, Blockly.onKeyDown_), Blockly.bindEvent_(document, "touchend", null, Blockly.longStop_), Blockly.bindEvent_(document, "touchcancel", null, Blockly.longStop_), goog.userAgent.IPAD && Blockly.bindEventWithChecks_(window, "orientationchange", document, function () {
...
Blockly.bindEventWithChecks_ = function (a, b, c, d, e, f) {
  ...
  if (goog.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP) for (var l = 0, n; n = Blockly.Touch.TOUCH_MAP[b][l]; l++) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","blockly/blockly_compressed.js"], null)
//# sourceMappingURL=/blockly_compressed.61e6ebe4.js.map