 ...
 */
const KruskalWallis = (df, significance, groupName, valueName) => {
 ...
 * @returns Result and legend.
 */
const TTestOneSample = (df, mean, significance, colName) => {
 ...
 * @returns Result and legend.
 */
const TTestPaired = (df, significance, leftCol, rightCol) => {
 ...
 * @returns Result and legend.
 */
const ZTestOneSample = (df, mean, stdDev, significance, colName) => {
  const samples = df.data.map(row => row[colName])
